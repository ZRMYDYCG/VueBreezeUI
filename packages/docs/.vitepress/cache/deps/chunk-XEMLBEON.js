...
function useBrowserLocation(options = {}) {
  ...
  if (window2) {
    useEventListener(window2, 'popstate', () => (state.value = buildState('popstate')), {
      passive: true
    })
    useEventListener(window2, 'hashchange', () => (state.value = buildState('hashchange')), {
      passive: true
    })
  }
  return state
  ...
  if (isClient) {
    ...
    const getFiles = (event) => {
      ...
      const list = Array.from(
        (_b = (_a = event.dataTransfer) == null ? void 0 : _a.files) != null ? _b : []
      )
    ...
    useEventListener(target, 'dragenter', (event) => {
      ...
      const types = Array.from(
        ((_a = event == null ? void 0 : event.dataTransfer) == null ? void 0 : _a.items) || []
      )
...
function useVModel(props, key, emit, options = {}) {
  ...
  if (!key) {
    if (isVue2) {
      const modelOptions =
        (_e = (_d = vm == null ? void 0 : vm.proxy) == null ? void 0 : _d.$options) == null
          ? void 0
          : _e.model
